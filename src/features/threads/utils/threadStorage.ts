export const STORAGE_KEY_THREAD_ACTIVITY = "claude-code-monitor.threadLastUserActivity";
export const STORAGE_KEY_PINNED_THREADS = "claude-code-monitor.pinnedThreads";
export const STORAGE_KEY_CUSTOM_NAMES = "claude-code-monitor.threadCustomNames";
